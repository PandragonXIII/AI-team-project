...
def markov_agent_test():
    ...
    main.single_test(AGENT_TYPE,None,True,train_times,test_times,
                                  withWeather=WEATHER, FROG_OF_WAR=FROG, visual=True)
    # env = gym.make("Taxi-v3", render_mode="human")
    # agent = main.Agent.MarkovSearchAgent(env=env)
    # # scores = main.single_test(AGENT_TYPE,agent,True,train_times,test_times,
